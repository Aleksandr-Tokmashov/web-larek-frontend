# Интернет "Веб-ларек"
Интернет-магазин товарами для веб-разработчиков. С помощью сервиса можно посмотреть каталог товаров, добавить товары в корзину и сделать заказ.
<br><br>
![{EB7E8EF4-A034-4298-AA70-A3E22F6D30D6}](https://github.com/user-attachments/assets/91f863f1-2468-4c8e-ad89-f6274b0aabbc)
<br><br>
...
## Что было сделано
- Спроектировал реализацию MVP-архитектуры веб-приложения
- Реализовал компоненты и модели данных приложения
- Задокументировал спроектированную архитектуру
